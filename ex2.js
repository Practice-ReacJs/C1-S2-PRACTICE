...
const STUDENTS_DATA = [
  ...
  { firstName: "Cẩm", lastName: "Le", batch: 2, age: 21 },
  { firstName: "An", lastName: "Vo", batch: 2, age: 19 },
];
...
// let getName = prompt("Nhập tên học sinh cần update tuổi: ");
// let getAge  = prompt("Nhập tuổi học sinh cần update: ");
